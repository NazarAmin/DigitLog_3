    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sheet1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_1.class));
            }
        });
        ...
        sheet2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_2.class));
            }
        });
        ...
        sheet3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_3.class));
            }
        });
        ...
        sheet4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_4.class));
            }
        });
        ...
        sheet5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_5.class));
            }
        });
        ...
        sheet6.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Dashboard_problem.this, Sheet_6.class));
            }
        });
