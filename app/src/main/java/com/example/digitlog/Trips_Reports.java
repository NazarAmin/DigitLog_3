...
public class Trips_Reports extends AppCompatActivity {
    ...
    private File filePath2 = new File(Environment.getExternalStorageDirectory() + "/Digit Log/Reports/Trips/" + engine + " Trips Report " + sdf2.format(new Date()) + ".xls");
...
*/
    ...
    private void getDatawork(){
        ...
        DatabaseReference ref2 = firebaseDatabase.getReference(GlobalClass.database + "/" + engine + "/tips_log");
