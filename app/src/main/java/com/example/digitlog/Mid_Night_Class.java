...
public class Mid_Night_Class {
    String gen, fuel, hp, lp, df, ds, gen_mv, fuel_mv, efs;

    public Mid_Night_Class(String gen, String fuel, String hp, String lp, String df, String ds, String gen_mv, String fuel_mv, String efs) {
        this.gen = gen;
        this.fuel = fuel;
        this.hp = hp;
        this.lp = lp;
