...
public class Status_Reports extends AppCompatActivity {
    ...
    private void getDatawork(){
        ...
        DatabaseReference ref2 = firebaseDatabase.getReference(GlobalClass.database + "/" + engine + "/Status_History");
        ...
        ref2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                hssfCell2.setCellValue("Status");
                HSSFCell hssfCell3 = hssfRow2.createCell(2);
                hssfCell3.setCellValue("Operator");
    ...
    public void openFolder(){
        ...
        Uri photoURI = FileProvider.getUriForFile(getApplicationContext(), Status_Reports.this.getApplicationContext().getPackageName() + ".provider", filePath2);
