...
public class Post {
    ...
    public DatabaseReference getref(String engine, String datetime, boolean check) {
        ...
        if (check) {
            ref2 = firebaseDatabase.getReference(GlobalClass.database + "/" + engine + "/faults_trips/" + datetime);
        } else {
            ref2 = firebaseDatabase.getReference(GlobalClass.database + "/" + engine + "/faults_trips/");
        }
        return ref2;
    }
