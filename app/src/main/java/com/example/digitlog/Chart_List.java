...
protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GlobalClass.engine_number.equals("Engine_3")){
                animalNames.add(this.getString(R.string.sp1));
                animalNames.add(this.getString(R.string.sp2));
                animalNames.add(this.getString(R.string.sp3));
                animalNames.add(this.getString(R.string.sp4));
                animalNames.add(this.getString(R.string.sp5));
                animalNames.add(this.getString(R.string.sp6));
                animalNames.add(this.getString(R.string.sp7));
                animalNames.add(this.getString(R.string.sp8));
                animalNames.add(this.getString(R.string.sp9));
                animalNames.add(this.getString(R.string.sp10));
                animalNames.add(this.getString(R.string.sp11));
                animalNames.add(this.getString(R.string.sp12));
                animalNames.add(this.getString(R.string.sp13));
                animalNames.add(this.getString(R.string.sp14));
                animalNames.add(this.getString(R.string.sp15));
                animalNames.add(this.getString(R.string.sp16));
                animalNames.add(this.getString(R.string.sp17));
                animalNames.add(this.getString(R.string.sp18));
                animalNames.add(this.getString(R.string.sp19));
                animalNames.add(this.getString(R.string.sp20));
                animalNames.add(this.getString(R.string.sp21));
                animalNames.add(this.getString(R.string.sp22));

                animalNames.add(this.getString(R.string.ssp2));
                animalNames.add(this.getString(R.string.ssp3));
                animalNames.add(this.getString(R.string.ssp4));
                animalNames.add(this.getString(R.string.ssp5));
                animalNames.add(this.getString(R.string.ssp6));
                animalNames.add(this.getString(R.string.ssp7));
                animalNames.add(this.getString(R.string.ssp8));
                animalNames.add(this.getString(R.string.ssp9));
                animalNames.add(this.getString(R.string.ssp10));
                animalNames.add(this.getString(R.string.ssp11));
                animalNames.add(this.getString(R.string.ssp12));
                animalNames.add(this.getString(R.string.ssp13));
                animalNames.add(this.getString(R.string.ssp14));
                animalNames.add(this.getString(R.string.ssp15));
                animalNames.add(this.getString(R.string.ssp16));
                animalNames.add(this.getString(R.string.ssp17));
                animalNames.add(this.getString(R.string.ssp18));
                animalNames.add(this.getString(R.string.ssp19));
                animalNames.add(this.getString(R.string.ssp20));
                animalNames.add(this.getString(R.string.ssp21));
                animalNames.add(this.getString(R.string.ssp22));
                animalNames.add(this.getString(R.string.ssp23));
                animalNames.add(this.getString(R.string.ssp24));
                animalNames.add(this.getString(R.string.ssp25));
                animalNames.add(this.getString(R.string.ssp26));
                animalNames.add(this.getString(R.string.ssp27));
                animalNames.add(this.getString(R.string.ssp28));
                animalNames.add(this.getString(R.string.ssp29));
                animalNames.add(this.getString(R.string.ssp30));
        }else {
