...
public class Sheet_6 extends AppCompatActivity {
    EditText p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15,p16,p17,p18;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new Dialog(Sheet_6.this);
        ...
        p1 = (EditText) findViewById(R.id.p6p1);
        p2 = (EditText) findViewById(R.id.p6p2);
        p3 = (EditText) findViewById(R.id.p6p3);
        p4 = (EditText) findViewById(R.id.p6p4);
        p5 = (EditText) findViewById(R.id.p6p5);
        p6 = (EditText) findViewById(R.id.p6p6);
        p7 = (EditText) findViewById(R.id.p6p7);
        p8 = (EditText) findViewById(R.id.p6p8);
        p9 = (EditText) findViewById(R.id.p6p9);
        p10 = (EditText) findViewById(R.id.p6p10);

        p11 = (EditText) findViewById(R.id.p6p11);
        p12 = (EditText) findViewById(R.id.p6p12);
        p13 = (EditText) findViewById(R.id.p6p13);
        p14 = (EditText) findViewById(R.id.p6p14);
        p15 = (EditText) findViewById(R.id.p6p15);
        p16 = (EditText) findViewById(R.id.p6p16);
        p17 = (EditText) findViewById(R.id.p6p17);
        p18 = (EditText) findViewById(R.id.p6p18);
    ...
    private void save_function() {
        ...
        try{
            ...
            data.setIp17(iip17);
            data.setIp18(iip18);
            data.setLogsheet("Log_Sheet_6");
            data.setUser(user);

            FirebaseDatabase firebaseDatabase = FirebaseDatabase.getInstance();

            DatabaseReference ref2 = firebaseDatabase.getReference(GlobalClass.database + "/" + engine + "/Log_Sheet_6");
